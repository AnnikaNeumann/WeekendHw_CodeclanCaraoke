...
# Give rooms a name, max guest capacity and song
    def setUp(self):
        self.room_1 = Room("Banshee Labyrinth",3,15)
...
#  set up guests, age, cash and name
        ...
        self.guest_3 = Guest(30, 55, "Commander Riker")
        self.guest_4 = Guest(40, 45, "Commander Chakotay")
        self.guest_5 = Guest(40, 10, "Riply")
...
# test to check room has name
    ...
    def test_room_has_max_guest_count(self):
        self.assertEqual(3,self.room_1.max_guests)
